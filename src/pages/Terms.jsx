...
function Terms() {
  ...
  return (
    <><div className="terms-container" id="terms-container" data-aos="zoom-out-up">
      ...
      <p className="terms terms-text">As long as the website and the information and services  website are provided free of charge, we will not be liable for any loss or damage of any nature.</p>
